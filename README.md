...
My goal with this project is to introduce lazy evaluation via polars, powered by fastAPI as a backend, and TypeScript for the GUI in a local server on your browser for nodes operations.