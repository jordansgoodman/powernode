...
# Clear node folder
# --------------------------------
code, msg = safe_delete(f"/workflow/{WORKFLOW_NAME}/nodes/join_sales_features/clear")
print("Clear node folder (join_sales_features):", code, msg)
line()

# --------------------------------
# Delete a specific node
# --------------------------------
code, msg = safe_delete(f"/workflow/{WORKFLOW_NAME}/nodes/join_sales_features")
print("Delete node (join_sales_features):", code, msg)
line()
